...
//
//  ★ HOW TO USE ★
//  1. Copy this file to your iPhone
//  2. Compile: clang++ -framework Foundation -framework UIKit keygen.mm KeyAuth.mm -o keygen
//  3. Run: ./keygen <device_udid>
//  4. Output: XXXX-XXXX-XXXX-XXXX
//
//  ★ GET USER'S UDID ★
//  Ask user to run: ./keygen --list
//  Or add a "Show My UDID" button in the mod menu
//
//  ★ CHANGE SECRET ★
